                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                            <span className="text-primary-600">Argentum Credit Corp</span>
                        </h1>
                        <p className="mt-6 text-xl text-gray-600 max-w-lg">
                            {/* paypal */}
                            Secure your future with the help of your loan value – a loan up to <span className="font-bold text-primary-600">₱ 100,000 - ₱ 10,000,000</span>
                        </p>
