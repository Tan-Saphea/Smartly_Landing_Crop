      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-300 mb-8 leading-relaxed">
            Smarty Lending Corporation offers flexible borrowing options.
            Leverage your current loan as collateral for the funds you need.
            Cover tuition, purchase equipment/furniture, travel, consolidate
            debt, or meet any financial requirement with our lending solutions.
          </p>
          <p className="text-lg text-gray-300 leading-relaxed mb-10">
            We offer a wide range of loan products and services to achieve your
            financial goals with ease. Apply now and start realizing your
            dreams.
          </p>
