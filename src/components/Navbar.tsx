                ...
                {isOpen && (
                    ...
                    >
                        <div className="px-4 pt-4 pb-6 space-y-4">
                            ...
                            <a href="https://ofwfinancialservice.com/register" target="_blank" rel="noopener noreferrer" className="block w-full text-center bg-primary-600 text-white px-6 py-3 rounded-lg font-medium shadow-lg shadow-primary-600/20">
                                Apply Now
                            </a>
                        </div>
                    </motion.div>
